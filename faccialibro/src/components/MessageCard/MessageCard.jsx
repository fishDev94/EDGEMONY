...
const formatData = (date) => {
  ...
  return (
    <div className="MessageCard">
      ...
      {
      isVisibile && <ModalWindow type='submit' deleteFn={onBtnClick} setVisibile={setVisibile} setCondition={setDeletable} valueDeletable={isDeletable} mainModalText={"Vuoi davvero eliminare il seguente Post selezionato?"}/>
      }   
      </div>
  )
}
